      ...
      <?php
        if(isset($_SESSION["userId"])){
          ?>
              ...
              <li class=""><a href="<?php echo URL?>home/malaria"><span class=""></span> Malaria</a></li>
              <li class=""><a href="<?php echo URL?>home/typhoid"><span class=""></span> Typhoid</a></li>
              <li class=""><a href="<?php echo URL?>home/reports"><span class=""></span> Reports</a></li>
              <li class=""><a href="<?php echo URL?>home/logout"><span class=""></span> Log out</a></li>
