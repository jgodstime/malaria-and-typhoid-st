...
class AdminController
{
    ...
    public function report(){
        // html data
        $data["title"] = "Reports"; /* for <title></title> inside header.php in this case */
        // load views
        $this->View->render('admin/reports', $data);   
    }

    public function users(){
        // html data
        $data["title"] = "User Report"; /* for <title></title> inside header.php in this case */
        // load views
